...
export const Navbar = () => {
    ...
    return (
        <header className="md:sticky md:top-0 md:w-11/12 Item-center m-auto text-textcolor-900 bg-[#0d5a5f] md:bg-transparent border-hidden shadow-none">
            <div className="flex items-center justify-between md:justify-around w-[93%] hover:bg-transparent/30 pb-1">
                ...
                <NavLink to="/" className="md:hidden flex items-center text-center text-white h-5 w-5">
