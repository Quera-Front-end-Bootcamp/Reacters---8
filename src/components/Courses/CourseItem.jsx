      ...
      <div className="flex cursor-pointer relative">
        ...
        <div dir="ltr" className="group text-end rounded-xl w-auto h-auto shadow-xl transition delay-150 ease-in-out hover:-translate-y-3 hover:scale-110 duration-300 bg-white">
          <div className="group relative">
            <img className="w-64 h-48 object-cover border border-gray-300 rounded-md" src={data.lesson.image} alt="courseImage"></img>
          ...
          <div className="pb-4 px-4 text-sm text-gray-500">ظرفیت : {data.capacity.toLocaleString("fa")} نفر</div>
