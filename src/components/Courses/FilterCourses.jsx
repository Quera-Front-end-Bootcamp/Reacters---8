...
const FilterCourses = ({ setFilteredCourses, coursesData }) => {
    ...
    return (
        <div dir="rtl" className="w-full md:block flex justify-center">
            <div className="flex-col justify-center w-full gap-8 lg:gap-0 lg:w-[calc(100%-7rem)] flex lg:flex-row lg:justify-between items-center">
                <div className="font-semibold text-2xl text-[#0d5a5f] lg:ml-8 lg:mr-28 m-0 lg:text-right text-center">
                    <p>دوره های آموزشی</p>
                </div>

                {/* filterSection in min-width: 768px : Dropdown */}
                <div className="group md:hidden inline-block relative font-medium text-gray-700 md:p-0 pt-4">
                    <button className="bg-gray-300 text-[#0d5a5f] border-[#0d5a5f] font-semibold py-4 px-14 rounded inline-flex justify-around border">
