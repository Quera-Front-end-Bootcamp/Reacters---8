...
const DUMMY_ARRAY = [
  {
    ...
    title: 'react course',
    count: 50,
    icon: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ8XZ8-OTu4_T3Fa2lyfTc99psyJ23m3JtVbA&usqp=CAU"
  },
  {
    id: '12',
    title: 'vue course',
    count: 32,
    icon: "https://avatars.githubusercontent.com/u/6128107?s=280&v=4"
  },
  {
    id: '13',
  ...
  },
  {
    ...
    title: 'nextjs course',
    count: 25,
    icon: "https://images.ctfassets.net/fdt52x6qf2de/1MVOW9GweIGspjGTSrYgBk/7c3b3cf133c4db02b5cdd7559c3e3c93/next-js.svg"
  },
]
        ...
        <Grid container spacing={3}>
          {DUMMY_ARRAY.map((item) => (
            <Grid key={item.id} item xs={12} sm={6} md={3}>
              <AppWidgetSummary key={item.id} title={item.title} count={item.count} icon={item.icon} />
            </Grid>
          ))}
        </Grid>
      </Container>
