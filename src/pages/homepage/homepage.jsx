      ...
      <main dir="rtl">
        ...
        <section className="flex flex-col lg:flex-row min-h-screen pb-28">
          <div className="w-full md:w-2/3 flex justify-center items-center py-10 lg:py-0">
            <div className="border-gray-400 border-2 w-[314px] min-h-[314px] relative flex flex-col gap-3">
          ...
          <div className="w-full md:w-1/3 flex flex-col gap-20 justify-center items-end text-[#093d41] border-b-2 border-r-2 border-slate-300 pl-28 pr-14 pt-24 h-fit">
