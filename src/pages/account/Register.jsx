...
function LoginPage() {
  return (
    ...
    <div className="page-login flex flex-col-reverse md:flex-row-reverse h-screen">
      <div className="form flex flex-col justify-center items-center flex-1 text-[#0d5a5f] md:overflow-none overflow-scroll pt-60 md:pt-12">
        <div className="w-9/12 py-8">
          ...
          <div className="flex flex-row-reverse text-input bg-gray-100 p-3 my-4 rounded-md">
            ...
            <input
              ...
              required className="flex-1 bg-transparent mx-2 outline-none w-3/5" />
          </div>
          <div className=" flex flex-row-reverse text-input bg-gray-100 p-3 my-4 rounded-md">
